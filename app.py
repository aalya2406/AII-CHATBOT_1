...
from functions import save_uploaded_file, extract_text_from_pdf, extract_text_from_txt, extract_text_from_image, get_assistant_response
import os
...
def main():
    ...
    uploaded_files = st.file_uploader("Choose files to upload", type=["pdf", "txt", "jpg", "jpeg", "png"], accept_multiple_files=True)
    ...
    if st.button("Send"):
        if 'text_content' in st.session_state:
            ...
            response = get_assistant_response(text_content, user_input)
